 ...
 * <p>
 * DOTPointDialog implementiert das Interface DOTDefinitionDialog für das Punkt-Plugin.
 * Hierzu interagiert es intensiv und software-technisch unsauber mit dem umschließenden 
...
public class DOTPointDialog implements DOTDefinitionDialog {
	...
	public JPanel getAdditionalCharacteristicsPanel( final DisplayObjectType displayObjectType) {
		...
		JLabel joinByLineLabel = new JLabel( "Vebindungslinie: ");
	...
	private StaticPanel createStaticComboBoxPanel( 
			PrimitiveForm primitiveForm, DOTProperty property,
			String labelText, Object[] items) {
	...
	private StaticPanel createStaticSpinnerPanel(
			PrimitiveForm primitiveForm, DOTProperty property,
			String labelText, SpinnerModel spinnerModel) {
		JLabel label = new JLabel( labelText);
	...
	private void addButtonListeners( final PrimitiveForm primitiveForm,
			final DOTProperty property,
